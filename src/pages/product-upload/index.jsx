...
const ProductUpload = () => {
  ...
  useEffect(() => {
    ...
    // If user tries to access product upload without authentication, show auth banner
    // but don't redirect - let them see the page and choose to login
  ...
  const handleProductSubmit = async () => {
    ...
    // If not authenticated, redirect to auth modal
    if (!isAuthenticated) {  
